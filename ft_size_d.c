...
/*   Updated: 2021/08/18 19:54:58 by vifernan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_point_p_sp(char *aux, int i, int length, t_vari *select, int size)
{
	char	*temp;
...
int	ft_point_sp(char *aux, int i, int length, t_vari *select, int size)
{
	char	*temp;
...
int	ft_ast(char *aux, int i, int length, t_vari *select, int size)
{
	char	*temp;
...
int	ft_nast_npoint(char *aux, int i, int length, t_vari *select, int size)
{
	char	*temp;
